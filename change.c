 ...
 #include<stdio.h>
 int main(){
 int dodo, gogo;//또또면과 공공바 가격을 저장할 변수 선언
...
w500 = change /500;// 및 연산자를 사용하여 500원 동전의 개수 계산

rest = change % 500;// 500원을 거슬러주고 동전의 개수 계산 W100 = rest / 100; 1/ 남은 잔돈에서 100원 동전의 개수 계산

w100 = rest / 100;//100원을 거슬러주고 남은 잔돈을 임시 보관
...
if (menu==0) break;
    ...
    printf("금액이 부족합니다. 다시 입력하려면 1 나가려면 0을 늘러주세요 ");
...
// 심화연습
//1. 또또면과 공공바의 가격을 상수(constant)으로 바꾸시오